...
static void timehandler(int sig);
...
static void timehandler(int sig)
{
	printf("change new file one min\n");
...
void set_timer(int sec)
{
	...
	itimer.it_interval = it_value;
	itimer.it_value = it_value;
...
void start_sniff(int filenum)
{
	...
	set_timer(60);  //1 min will change the file num
